...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x18C2C26f53e4c7F4Ccbe682BE46430832c4D4cd2", "edition-drop").contract;
  // トークンコントラクトの初期化
  const token = useContract("0x0B763E839D26d0df68300A754E4Ad8234C1D588D", "token").contract;
    // 投票コントラクトの初期化
  const vote = useContract("0xf22D998F6E6e94491Ba8124838273543d097bf60", "vote").contract;
